...
/**
 * SocialShareButtons - A reusable component for social media sharing
 * 
 * @param {Object} props
 ...
 * @param {string} [props.layout] - Layout of buttons ('row', 'column', 'grid')
...
const SocialShareButtons = ({
  ...
  const buttonClasses = `
    ...
    hover:shadow-md hover:scale-105 ${sizeClasses}
  `;
  ...
  return (
    <div className={`social-share-buttons ${layoutClasses} ${className}`}>
      {platforms.facebook && (
        <a
          ...
          className={`${buttonClasses} bg-[#1877F2] text-white`}
      ...
      {platforms.twitter && (
        <a
          ...
          className={`${buttonClasses} bg-[#1DA1F2] text-white`}
      ...
      {platforms.linkedin && (
        <a
          ...
          className={`${buttonClasses} bg-[#0A66C2] text-white`}
      ...
      {platforms.whatsapp && (
        <a
          ...
          className={`${buttonClasses} bg-[#25D366] text-white`}
      ...
      {platforms.telegram && (
        <a
          ...
          className={`${buttonClasses} bg-[#0088cc] text-white`}
      ...
      {platforms.pinterest && (
        <a
          ...
          className={`${buttonClasses} bg-[#E60023] text-white`}
      ...
      {platforms.email && (
        <a
          ...
          className={`${buttonClasses} bg-gray-600 text-white`}
