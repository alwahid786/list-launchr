...
export const entriesAPI = {
  ...
  submitEntryAction: (entryId, actionData) => axios.post(`${api.defaults.baseURL}/entries/${entryId}/actions`, actionData),
...
export const contactAPI = {
  sendContactMessage: (messageData) => api.post("/contact/submit", messageData),
};
